document.addEventListener("DOMContentLoaded", function () {
  ...
  async function loadUserProfile() {
    ...
    if (userData) {
      document.getElementById("dropdownUserName").textContent = userData.nome;
      document.getElementById("userName").textContent = userData.nome;
      document.querySelector(
        ".profile-overview .row:nth-child(1) .col-lg-9"
      ).textContent = userData.nome;
      document.querySelector(
        ".profile-overview .row:nth-child(2) .col-lg-9"
      ).textContent = userData.email;
      document.querySelector(
        ".profile-overview .row:nth-child(3) .col-lg-9"
      ).textContent = userData.data_cadastro;
    }
  }
